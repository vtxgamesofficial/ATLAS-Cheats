...
- Rebrand, republish, or claim authorship.
- Use this code in any commercial or non-commercial project.

Written permission from the copyright holder is required for any use beyond viewing.

Unauthorized use, reproduction, or distribution of this source code is prohibited.
]]


if IY_LOADED and not _G.IY_DEBUG then
	-- error("ATLAS is already running!", 0)
	return
end
...
-- xylex & europa
local iyassets = {
	["atlas/assets/bindsandplugins.png"] = "rbxassetid://5147695474",
	["atlas/assets/close.png"] = "rbxassetid://5054663650",
	["atlas/assets/editaliases.png"] = "rbxassetid://5147488658",
	["atlas/assets/editkeybinds.png"] = "rbxassetid://129697930",
	["atlas/assets/edittheme.png"] = "rbxassetid://4911962991",
	["atlas/assets/editwaypoints.png"] = "rbxassetid://5147488592",
	["atlas/assets/imgstudiopluginlogo.png"] = "rbxassetid://4113050383",
	["atlas/assets/logo.png"] = "rbxassetid://1352543873",
	["atlas/assets/minimize.png"] = "rbxassetid://2406617031",
	["atlas/assets/pin.png"] = "rbxassetid://6234691350",
	["atlas/assets/reference.png"] = "rbxassetid://3523243755",
	["atlas/assets/settings.png"] = "rbxassetid://1204397029"
}
...
if makefolder and isfolder and writefile and isfile then
	pcall(function() -- good executor trust
		...
		for _, folder in {"atlas", "atlas/assets"} do
		...
		for path in iyassets do
			if not isfile(path) then
				writefile(path, game:HttpGet((path:gsub("atlas/", assets))))
			end
		end
		-- honestly just blame your phone if the assets appear in your gallery
		if IsOnMobile then writefile("atlas/assets/.nomedia", "") end
	end)
end
...
Title.Parent = Holder
Title.Active = true
Title.BackgroundColor3 = Color3.fromRGB(64, 130, 246)
Title.BorderSizePixel = 0
Title.Size = UDim2.new(0, 250, 0, 20)
Title.Font = Enum.Font.GothamBold
Title.TextSize = 18
Title.Text = "ATLAS v" .. currentVersion
...
Dark.Parent = Holder
Dark.Active = true
Dark.BackgroundColor3 = Color3.fromRGB(22, 22, 26)
...
SettingsButton.Image = getcustomasset("atlas/assets/settings.png")
...
ReferenceButton.Image = getcustomasset("atlas/assets/reference.png")
ReferenceButton.ZIndex = 10

Settings.Name = "Settings"
Settings.Parent = Holder
Settings.Active = true
Settings.BackgroundColor3 = Color3.fromRGB(22, 22, 26)
...
ColorsButton = makeSettingsButton("Edit Theme",getcustomasset("atlas/assets/edittheme.png"))
ColorsButton.Position = UDim2.new(0, 5, 0, 55)
ColorsButton.Size = UDim2.new(1, -10, 0, 25)
ColorsButton.Name = "Colors"
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton("Edit Keybinds",getcustomasset("atlas/assets/editkeybinds.png"))
Keybinds.Position = UDim2.new(0, 5, 0, 85)
Keybinds.Size = UDim2.new(1, -10, 0, 25)
Keybinds.Name = "Keybinds"
Keybinds.Parent = SettingsHolder

Aliases = makeSettingsButton("Edit Aliases",getcustomasset("atlas/assets/editaliases.png"))
...
Positions = makeSettingsButton("Edit/Goto Waypoints",getcustomasset("atlas/assets/editwaypoints.png"))
Positions.Position = UDim2.new(0, 5, 0, 145)
Positions.Size = UDim2.new(1, -10, 0, 25)
Positions.Name = "Waypoints"
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton("Edit Event Binds",getcustomasset("atlas/assets/bindsandplugins.png"),759)
EventBind.Position = UDim2.new(0, 5, 0, 205)
EventBind.Size = UDim2.new(1, -10, 0, 25)
EventBind.Name = "EventBinds"
EventBind.Parent = SettingsHolder

Plugins = makeSettingsButton("Manage Plugins",getcustomasset("atlas/assets/bindsandplugins.png"),743)
...
CloseImage.Image = getcustomasset("atlas/assets/close.png")
...
PinImage.ZIndex = 10
PinImage.Image = getcustomasset("atlas/assets/pin.png")
...
IntroBackground.BackgroundColor3 = Color3.fromRGB(22, 22, 26)
...
Logo.Image = getcustomasset("atlas/assets/logo.png")
...
ExitImage_2.Image = getcustomasset("atlas/assets/close.png")
...
Img.Image = getcustomasset("atlas/assets/imgstudiopluginlogo.png")
Img.ZIndex = 10
...
ExitImage_3.Image = getcustomasset("atlas/assets/close.png")
...
PluginsHint.Text = "Download plugins from the ATLAS Discord"
...
ExitImage_5.Image = getcustomasset("atlas/assets/close.png")
...
ImageLabel.Image = getcustomasset("atlas/assets/minimize.png")
...
ImageLabel_2.Image = getcustomasset("atlas/assets/close.png")
...
eventEditor = (function()
	...
	local main = create({
		...
		{5,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("atlas/assets/close.png"),Parent={4},Position=UDim2.new(0,5,0,5),Size=UDim2.new(0,10,0,10),ZIndex=10,}},
		...
		{53,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("atlas/assets/settings.png"),Parent={52},Position=UDim2.new(0,2,0,2),Size=UDim2.new(0,16,0,16),ZIndex=10,}},
	})
	main.Name = randomString()
...
reference = (function()
	local main = create({
		...
		{114,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={112},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,32),Text="You can join the Discord server to get support with ATLAS,  and read up on more documentation such as the Plugin API.",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
	...
	inviteButton.MouseButton1Click:Connect(function()
		if everyClipboard then
			toClipboard("https://discord.gg/pcKuqTCggc")
		...
		inviteButton.Text = "Copy Discord Invite Link (https://discord.gg/pcKuqTCggc)"
	end)
	dragGUI(main)
	main.Parent = ScaledHolder
...
currentShade1 = Color3.fromRGB(22, 22, 26)
currentShade2 = Color3.fromRGB(30, 30, 36)
currentShade3 = Color3.fromRGB(52, 52, 60)
currentText1 = Color3.new(1, 1, 1)
currentText2 = Color3.new(0, 0, 0)
currentScroll = Color3.fromRGB(52,52,60)
...
function createPopup(title, text)
	...
	ExitImage.Image = getcustomasset("atlas/assets/close.png")
	ExitImage.ZIndex = 10
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- ATLAS Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Invite to the ATLAS discord server.'}
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/atlas/master/source'))()")
	end
end)
...
addcmd('discord', {'support', 'help'}, function(args, speaker)
	if everyClipboard then
		toClipboard('https://discord.gg/pcKuqTCggc')
		notify('Discord Invite', 'Copied to clipboard!\ndiscord.gg/pcKuqTCggc')
	else
		notify('Discord Invite', 'discord.gg/pcKuqTCggc')
	end
	if httprequest then
		httprequest({
...
addcmd('keepiy', {}, function(args, speaker)
	if queueteleport then
		KeepInfYield = true
		notify('KeepIY','ATLAS will now run after you teleport')
		updatesaves()
	else
...
addcmd('unkeepiy', {}, function(args, speaker)
	if queueteleport then
		KeepInfYield = false
		notify('KeepIY','ATLAS will no longer run after you teleport')
		updatesaves()
	else
		notify('Incompatible Exploit','Your exploit does not support this command (missing queue_on_teleport)')
	end
...
task.spawn(function()
	local success, latestVersionInfo = pcall(function() 
		local versionJson = game:HttpGet("https://raw.githubusercontent.com/EdgeIY/atlas/master/version")
